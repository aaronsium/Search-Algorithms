//
// Created by yaffa on 1/23/20.
//

#include "General.h"
void MyParallelServer::open(int port, ClientHandler *myHandler) {
...
int MyParallelServer::newSocket(int port) {
...
void MyParallelServer::start(ClientHandler *myHandler) {
